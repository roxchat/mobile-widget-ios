...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RoxChatMobileWidget/RoxChatMobileWidget.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RoxchatClientLibrary/RoxchatClientLibrary.framework"
